...
# Script to encode qt-prolongation-lens.js to base64 and update qt-prolongation-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/qt-prolongation-lens.js"
JSON_FILE="$PROJECT_DIR/qt-prolongation-lens.json"
...
console.log('✅ Updated qt-prolongation-lens.json with encoded JS');
"
